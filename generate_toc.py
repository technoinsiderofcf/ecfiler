...
# --- 🏛️ THE FULL-WIDTH HANGING TAB 🏛️ ---
def get_styles():
    # leftIndent=0 makes wrapped lines go to the far left margin
    ...
    return {
        ...
        'L1': ParagraphStyle('L1', **base, firstLineIndent=0.5*inch), # II.
        'L2': ParagraphStyle('L2', **base, firstLineIndent=0.75*inch), # A.
        'L3': ParagraphStyle('L3', **base, firstLineIndent=1.0*inch), # 16.
    }
...
def apply_spacing(content, p_num):
    ...
    if l1_match:
        ...
        return (f"<b>{content}</b>", styles['L1'])

    # We add a few spaces (non-breaking) to act as the "Tab" after the number
    # This keeps the wrapped lines starting at 0 (the far left)
...
if os.path.exists(source_pdf):
    ...
    print("BACK TO FULL WIDTH: REFRESHED")
